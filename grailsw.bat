...
if "x%GRAILS_AGENT_CACHE_DIR%" == "x" set GRAILS_AGENT_CACHE_DIR=%SHORTHOME%/.grails/2.2.4/
...
if "%GRAILS_OPTS%" == "" set GRAILS_OPTS=-server -Xmx768M -Xms64M -XX:MaxPermSize=256m -Dfile.encoding=UTF-8
...
set STARTER_CLASSPATH=wrapper/grails-wrapper-runtime-2.2.4.jar;wrapper;.
...
set JAVA_OPTS=%JAVA_OPTS% -Dgrails.version=2.2.4
