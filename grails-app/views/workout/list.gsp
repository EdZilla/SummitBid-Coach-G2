	...
	<body>
		...
		<div id="list-workout" class="content scaffold-list" role="main">
			...
			<table>
				...
				<!-- 		<g:sortableColumn property="uuid" title="${message(code: 'workout.uuid.label', default: 'Uuid')}" /> -->
					
						<g:sortableColumn property="name" title="${message(code: 'workout.name.label', default: 'Name')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'workout.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'workout.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${workoutInstanceList}" status="i" var="workoutInstance">
					...
					<!--  <td>${fieldValue(bean: workoutInstance, field: "uuid")}</td> --> 					
												
						<td><g:link action="show" id="${workoutInstance.id}">${fieldValue(bean: workoutInstance, field: "name")}</g:link></td>
					
						<td><g:formatDate date="${workoutInstance.dateCreated}" /></td>
					
						<td><g:formatDate date="${workoutInstance.lastUpdated}" /></td>
					
						<td>${fieldValue(bean: workoutInstance, field: "description")}</td>
